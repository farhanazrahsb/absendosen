  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Rekap Mahasiswa</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="fa fa-laptop"></i>Rekap Mahasiswa</li>						  	
					</ol>
				</div>
			</div>
      <a href="input_mahasiswa.php"><button class="btn btn-primary">Tambah</button></a>
          <div class="container">
          <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
          <caption><h4>Rekap Data Mahasiswa</h4></caption>
          <thead>
            <tr>
            <th>No</th>
            <th>NPM</th>
          ...
          while ($var=mysql_fetch_array($query)) {
            ...
            <tr>
              ...
              <td><?php echo "<a class='fa fa-pencil-square-o' title='Edit' href='updatemhs.php?no=$var[no]'></a> |<a class='fa fa-trash-o' title='Hapus' href='deletemhs.php?no=$var[no]'></a>"; ?></td>
            </tr>
