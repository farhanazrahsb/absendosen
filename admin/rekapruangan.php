  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Rekap Ruangan</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="fa fa-laptop"></i>Rekap Ruangan</li>						  	
					</ol>
				</div>
			</div>
			<a href="input_ruangan.php"><button class="btn btn-primary">Tambah</button></a>
          <div class="container">
          <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
          <caption><h4>Rekap Data Ruangan</h4></caption>
          <thead>
            <tr>
            <th>No</th>
            <th>Ruang</th>
          ...
          $query = mysql_query ("SELECT * FROM rekap_ruang order by kd_kls asc");
          $no=1;
          ...
          $kls=mysql_fetch_array(mysql_query("SELECT kls FROM kelas WHERE kd_kls='$var[kd_kls]'"));
            ...
            <tr>
              ...
              <td><?php echo $var ['status_ruang']; ?></td>
              <td><?php echo "<a class='fa fa-pencil-square-o' title='Edit' href='updateruangan.php?no=$var[no]'></a> |<a class='fa fa-trash-o' title='Hapus' href='deleteruangan.php?no=$var[no]'></a>"; ?></td>
            </tr>
