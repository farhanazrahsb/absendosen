...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM dosen WHERE no=".$_GET['no'];
...
$email          = $_POST['email'];
 ...
 $sql_query = "UPDATE dosen SET id_dosen='$id_dosen', nama='$nama', user='$user', pass='$pass', email='$email' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapdosen.php';
  </script>
  <?php
 }
 else
...
{
 header("Location: rekapdosen.php");
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Dosen</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Dosen</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
