  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Input Kelas</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Input Kelas</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form action="inputkelas_proses.php" method="post">
            ...
            <div class="col-xs-4">
                <input type="text" name="kd_kls" class="form-control" placeholder="Kode Kelas">
            </div><br><br>
            <div class="form-group">
