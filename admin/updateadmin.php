...
$email          = $_POST['email'];
 ...
 $sql_query = "UPDATE admin SET id_admin='$id_admin', nama='$nama', user='$user', pass='$pass', email='$email' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapadmin.php';
  </script>
  <?php
 }
 else
...
{
 header("Location: rekapadmin.php");
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Admin</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Admin</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form method="post">
            ...
            <div class="col-xs-4">
                <input type="text" name="id_admin" class="form-control" placeholder="ID Admin" value="<?php echo $row['id_admin']; ?>">
            </div><br><br>
            <div class="form-group">
