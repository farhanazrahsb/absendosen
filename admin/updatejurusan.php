...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM jurusan WHERE no=".$_GET['no'];
...
$jurus           = $_POST['jurus'];
 ...
 $sql_query = "UPDATE jurusan SET kd_jurus='$kd_jurus', jurus='$jurus' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapjurusan.php';
  </script>
  <?php
 }
 else
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Jurusan</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Jurusan</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form action="" method="post">
            ...
            <div class="col-xs-4">
                <input type="text" name="jurus" class="form-control" placeholder="Jurusan"  value="<?php echo $row['jurus']; ?>">
            </div><br><br>
            <div class="form-group">
