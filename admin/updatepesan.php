...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM absen_mhs WHERE no=".$_GET['no'];
...
$pesan          = $_POST['pesan'];
 ...
 $sql_query = "update absen_mhs SET ket_absen='$ket_absen', pesan='$pesan' WHERE no=".$_GET['no'];
 // sql query for update data into database
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Pesan</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Pesan</li>			  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form action="" method="post">
            ...
            <div class="form-group">
            <label class="control-label col-xs-2">Status Kehadiran</label>
            <div class="col-xs-4">
                <select name="ket_absen" class="form-control">
