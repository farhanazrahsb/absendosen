  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Input Ruang</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Input Ruang</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form action="inputruang_proses.php" method="post">
            <div class="form-group">
            <label class="control-label col-xs-2">Kode Ruang</label>
            <div class="col-xs-4">
                <input type="text" name="kd_ruang" class="form-control" placeholder="Kode Ruang">
            </div><br><br>
            <div class="form-group">
