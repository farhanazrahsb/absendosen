...
$email          = $_POST['email'];
 ...
 $sql_query = "UPDATE admin SET id_admin='$id_admin', nama='$nama', user='$user', pass='$pass', email='$email' WHERE id_admin='$id_admin'";
 // sql query for update data into database
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          ...
          <form method="post">
            ...
            <div class="col-xs-4">
                <input type="text" name="id_admin" class="form-control" placeholder="ID Admin" value="<?php echo $row['id_admin']; ?>" readonly>
            </div><br><br>
            <div class="form-group">
