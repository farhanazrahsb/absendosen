...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM rekap_ruang WHERE no=".$_GET['no'];
...
$status_ruang       = $_POST['status_ruang'];
 ...
 $sql_query = "UPDATE rekap_ruang SET status='$status', status_ruang='$status_ruang' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapruangan.php';
  </script>
  <?php
 }
 else
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Ruangan</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Ruangan</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
