            ...
            <div class="row">
                <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box blue-bg">
                        ...
                        <div class="count">Input Dosen</div>
                        <div class="title"><a href="input_dosen.php">View Details</a></div>                       
                    </div><!--/.info-box-->         
                </div><!--/.col-->
                ...
                <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box magenta-bg">
                        <i class="fa fa-plus"></i>
                        <div class="count">Input Mahasiswa</div>
                        <div class="title"><a href="input_mahasiswa.php">View Details</a></div>                      
                    </div><!--/.info-box-->         
                </div><!--/.col-->  
                ...
                <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box brown-bg">
                        <i class="fa fa-plus"></i>
                        <div class="count">Input Admin</div>
                        <div class="title"><a href="input_admin.php">View Details</a></div>                      
                    </div><!--/.info-box-->         
                </div><!--/.col-->  
                ...
                <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box red-bg">
                        <i class="fa fa-plus"></i>
                        <div class="count">Input Jurusan</div>
                        <div class="title"><a href="input_jurusan.php">View Details</a></div>                      
                    </div><!--/.info-box-->         
                </div><!--/.col-->  
                ...
                <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box yellow-bg">
                        <i class="fa fa-plus"></i>
                        <div class="count">Input Kelas</div>
                        <div class="title"><a href="input_kelas.php">View Details</a></div>                      
                    </div><!--/.info-box-->         
                </div><!--/.col-->  
                ...
                <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box dark-bg">
                        <i class="fa fa-plus"></i>
                        <div class="count">Input Mata Kuliah</div>
                        <div class="title"><a href="input_matkul.php">View Details</a></div>                      
                    </div><!--/.info-box-->         
                </div><!--/.col-->  
                ...
                <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box purple-bg">
                        <i class="fa fa-plus"></i>
                        <div class="count">Input Ruang</div>
                        <div class="title"><a href="input_ruang.php">View Details</a></div>                      
                    </div><!--/.info-box-->         
                </div><!--/.col-->   
                ...
                <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box green-bg">
                        <i class="fa fa-plus"></i>
                        <div class="count">Input Jadwal</div>
                        <div class="title"><a href="input_jadwal.php">View Details</a></div>                      
                    </div><!--/.info-box-->         
                </div><!--/.col-->         
            </div><!--/.row-->
      </section>
