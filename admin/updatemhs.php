...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM mahasiswa WHERE no=".$_GET['no'];
...
$email          = $_POST['email'];
 ...
 $sql_query = "UPDATE mahasiswa SET npm='$npm', nama='$nama', user='$user', pass='$pass', email='$email' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapmahasiswa.php';
  </script>
  <?php
 }
 else
...
{
 header("Location: rekapmahasiswa.php");
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Mahasiswa</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Mahasiswa</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form method="post">
            ...
            <label class="control-label col-xs-2">NPM</label>
            <div class="col-xs-4">
                <input type="text" name="npm" class="form-control" placeholder="ID Admin" value="<?php echo $row['npm']; ?>">
            </div><br><br>
            <div class="form-group">
