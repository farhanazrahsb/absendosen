  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Input Jurusan</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Input Jurusan</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form action="inputjurus_proses.php" method="post">
            <div class="form-group">
            <label class="control-label col-xs-2">Kode Jurusan</label>
            <div class="col-xs-4">
                <input type="text" name="kd_jurus" class="form-control" placeholder="Kode Jurusan">
            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Jurusan</label>
            <div class="col-xs-4">
                <input type="text" name="jurus" class="form-control" placeholder="Jurusan">
            </div><br><br>
            <div class="form-group">
