  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-laptop"></i> Rekap Jadwal</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="fa fa-laptop"></i>Rekap Jadwal</li>						  	
					</ol>
				</div>
			</div>
      <a href="input_jadwal.php"><button class="btn btn-primary">Tambah</button></a>
          <div class="container">
          <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
          <caption><h4>Rekap Data Jadwal</h4></caption>
          <thead>
            <tr>
            <th>No</th>
            <th>Nama Dosen</th>
          ...
          while ($var=mysql_fetch_array($query)) {
            ...
            $jurus=mysql_fetch_array(mysql_query("SELECT jurus FROM jurusan WHERE kd_jurus='$var[kd_jurus]'"));
            ?>
            <tr>
              <td><?php echo $no ?></td>
              <td><?php echo $nama ['nama']; ?></td>
              <td><?php echo $matkul ['matkul']; ?></td>
              <td><?php echo $jurus ['jurus']; ?></td>
              ...
              <td><?php echo "<a class='fa fa-pencil-square-o' title='Edit' href='updatejadwal.php?no=$var[no]'></a> |<a class='fa fa-trash-o' title='Hapus' href='deletejadwal.php?no=$var[no]'></a>"; ?></td>
            </tr>
