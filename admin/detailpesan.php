...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-laptop"></i> Rekap Pesan Absen Dosen</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
            <li><i class="fa fa-laptop"></i>Rekap Pesan Absen Dosen</li>                
          </ol>
        </div>
      </div>
      <a class="btn btn-info" onclick=self.history.back()> <span class="fa fa-arrow-left" title="Kembali"></span></a>
          <div class="container">
          <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
          <caption><h4>Rekap Data Pesan Absen Dosen</h4></caption>
          <?php
          include ('../koneksi/koneksi.php');

          $id_dosen = $_GET['id_dosen'];
          $query = mysql_query("SELECT distinct id_dosen FROM absen_mhs WHERE id_dosen='$id_dosen'");
          while ($var=mysql_fetch_array($query)) {
            $nama=mysql_fetch_array(mysql_query("SELECT nama FROM dosen WHERE id_dosen='$var[id_dosen]'"));
          ?>
          <caption><h4><b><?php echo $nama ['nama']; ?></b></h4></caption>
          <?php
          }
          ?>
          <thead>
            ...
            <th>Minggu</th>
            <th>Kelas</th>
            <th>Keterangan Hadir Ke Mahasiswa</th>
            <th>Pesan Ke Mahasiswa</th>
            </tr>
          </thead>
          <tbody>
          <?php
          ...
          $id_dosen = $_GET['id_dosen'];
          $query = mysql_query("SELECT * FROM absen_mhs WHERE id_dosen='$id_dosen'");
          $no=1;
          while ($var=mysql_fetch_array($query)) {
          ?>
            <tr>
