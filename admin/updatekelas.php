...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM kelas WHERE no=".$_GET['no'];
...
$kls           = $_POST['kls'];
 ...
 $sql_query = "UPDATE kelas SET kd_jurus='$kd_jurus', kd_kls='$kd_kls', kls='$kls' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapkelas.php';
  </script>
  <?php
 }
 else
...
{
 header("Location: rekapkelas.php");
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Upadte Kelas</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Kelas</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-4">
                <input type="text" name="kls" class="form-control" placeholder="Kelas" value="<?php echo $row['kls']; ?>">
            </div><br><br>
            <div class="form-group">
