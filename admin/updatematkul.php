...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM matkul WHERE no=".$_GET['no'];
...
$matkul          = $_POST['matkul'];
 ...
 $sql_query = "UPDATE matkul SET kd_matkul='$kd_matkul', matkul='$matkul' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapmatkul.php';
  </script>
  <?php
 }
 else
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Mata Kuliah</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Mata Kuliah</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form action="" method="post">
            ...
            <div class="col-xs-4">
                <input type="text" name="matkul" class="form-control" placeholder="Mata Kuliah" value="<?php echo $row['matkul']; ?>">
            </div><br><br>
            <div class="form-group">
