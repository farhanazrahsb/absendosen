...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-laptop"></i> Rekap Absen Dosen</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
            <li><i class="fa fa-laptop"></i>Rekap Absen Dosen</li>                
          </ol>
        </div>
      </div>
          <div class="container">
          ...
          <caption><h4>Rekap Data Absen Dosen</h4></caption>
          <thead>
            <tr>
            <th>No</th>
            <th>ID Dosen</th>
          ...
          while ($var=mysql_fetch_array($query)) {
          	 $nama=mysql_fetch_array(mysql_query("SELECT nama FROM dosen WHERE id_dosen='$var[id_dosen]'"));
          ?>
            <tr>
              <td><?php echo $no ?></td>
              <td><?php echo $var ['id_dosen']; ?></td>
              <td><?php echo $nama ['nama']; ?></td>
              <td><?php echo $var ['kd_jurus']; ?></td>
              <td><?php echo $var ['kd_kls']; ?></td>
              <td><?php echo $var ['kd_matkul']; ?></td>
              <td><?php echo $var ['minggu']; ?></td>
              <td><?php echo $var ['kd_ruang']; ?></td>
              <td><?php echo $var ['waktu']; ?></td>
              <td><?php echo $var ['ket_absen']; ?></td>
              <td><?php echo $var ['pesan']; ?> <a class="fa fa-eye" href="detailpesan.php?&id_dosen=<?php echo $var['id_dosen']; ?>" title="Detail Pesan"></a> | <?php echo "<a class='fa fa-pencil-square-o' title='Edit Pesan Ke Mahasiswa' href='updatepesan.php?no=$var[no]'></a>"; ?></td>
              <td><?php echo "<a class='fa fa-pencil-square-o' title='Edit' href='updateabsen.php?no=$var[no]'></a> |<a class='fa fa-trash-o' title='Hapus' href='deleteabsen.php?no=$var[no]'></a>"; ?></td>
            </tr>
            <?php
            $no++;
          }
