  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Input Jadwal</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Input Jadwal</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form action="inputjadwal_proses.php" method="post">
            <div class="form-group">
            <label class="control-label col-xs-2">Nama Dosen</label>
            <div class="col-xs-4">
            <select name="id_dosen" id="id_dosen" class="selectpicker form-control" data-live-search="true" onchange="changeValue(this.value)">
            <option value="" selected>-- Nama Dosen --</option>
                ...
                $jsArray .= "dtMhs['" . $row['id_dosen'] . "'] = {nama:'" . addslashes($row['user']) . "'};\n";    
                }      
                ?>    
                </select>            
            </div><br><br>
            ...
            <div class="col-xs-4">
            <input type="text" name="user" class="form-control" id="user" readonly>  

            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Mata Kuliah</label>
            <div class="col-xs-4">
                <select name="kd_matkul" class="selectpicker form-control" data-live-search="true">
            <option value="" selected>-- Mata Kuliah --</option>
                <?php 
                include "../koneksi/koneksi.php";
                
                $query=mysql_query("select * from matkul order by kd_matkul asc");
                
                while($row=mysql_fetch_array($query))
                {
                ?>
                <option value="<?php  echo $row['kd_matkul']; ?>"><?php  echo $row['matkul']; ?></option>
                <?php 
                }
                ?>
                </select>    
            ...
            <div class="form-group">
            <label class="control-label col-xs-2">Jurusan</label>
            <div class="col-xs-4">
                <select name="kd_jurus" class="selectpicker form-control" data-live-search="true">
            <option value="" selected>-- Jurusan --</option>
                <?php 
                include "../koneksi/koneksi.php";
                
                $query=mysql_query("select * from jurusan order by kd_jurus asc");
                
                while($row=mysql_fetch_array($query))
                {
                ?>
                <option value="<?php  echo $row['kd_jurus']; ?>"><?php  echo $row['jurus']; ?></option>
                <?php 
                }
                ?>
                </select>    
            ...
            <div class="col-xs-4">
                <select name="kd_kls" class="selectpicker form-control" data-live-search="true">
            ...
            <div class="col-xs-4">
                <select name="kd_ruang" class="selectpicker form-control" data-live-search="true">
...
<script type="text/javascript">    
    <?php echo $jsArray; ?>  
    function changeValue(id_dosen){  
    document.getElementById('user').value = dtMhs[id_dosen].nama;  
    };  
    </script> 
