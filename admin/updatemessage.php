...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM message WHERE no=".$_GET['no'];
...
$message          = $_POST['message'];
 ...
 $sql_query = "UPDATE message SET status='$status', name='$name', email='$email', message='$message' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapmessage.php';
  </script>
  <?php
 }
 else
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Message</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Message</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form method="post">
            ...
            <div class="col-xs-4">
                <input type="text" name="message" class="form-control" placeholder="Message" value="<?php echo $row['message']; ?>">
            </div><br><br>
            <div class="form-group">
