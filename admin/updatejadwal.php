...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM jadwal WHERE no=".$_GET['no'];
...
$kd_ruang          = $_POST['kd_ruang'];
 ...
 $sql_query = "UPDATE jadwal SET kd_matkul='$kd_matkul', id_dosen='$id_dosen', kd_jurus='$kd_jurus', kd_kls='$kd_kls', hari='$hari', sesi_awal='$sesi_awal', sesi_akhir='$sesi_akhir', kd_ruang='$kd_ruang' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapjadwal.php';
  </script>
  <?php
 }
 else
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Jadwal</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Jadwal</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form method="post">
            ...
            <div class="col-xs-4">
                <input type="text" name="id_dosen" class="form-control" placeholder="ID Dosen" value="<?php echo $row['id_dosen']; ?>">
            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Mata Kuliah</label>
            <div class="col-xs-4">
                <input type="text" name="kd_matkul" class="form-control" placeholder="Mata Kuliah" value="<?php echo $row['kd_matkul']; ?>">
            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Jurusan</label>
            <div class="col-xs-4">
                <input type="text" name="kd_jurus" class="form-control" placeholder="Kelas" value="<?php echo $row['kd_jurus']; ?>">
            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Kelas</label>
            <div class="col-xs-4">
                <input type="text" name="kd_kls" class="form-control" placeholder="Kelas" value="<?php echo $row['kd_kls']; ?>">
            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Hari</label>
            <div class="col-xs-4">
                <input type="text" name="hari" class="form-control" placeholder="Hari" value="<?php echo $row['hari']; ?>">
            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Sesi Awal</label>
            <div class="col-xs-4">
                <input type="text" name="sesi_awal" class="form-control" placeholder="Sesi Awal" value="<?php echo $row['sesi_awal']; ?>">
            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Sesi Akhir</label>
            <div class="col-xs-4">
                <input type="text" name="sesi_akhir" class="form-control" placeholder="Sesi Akhir" value="<?php echo $row['sesi_akhir']; ?>">
            </div><br><br>
            <div class="form-group">
