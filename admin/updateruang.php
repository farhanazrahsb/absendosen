...
if(isset($_GET['no']))
{
 $sql_query="SELECT * FROM ruang WHERE no=".$_GET['no'];
...
$ruang              = $_POST['ruang'];
 ...
 $sql_query = "UPDATE ruang SET kd_ruang='$kd_ruang', ruang='$ruang' WHERE no=".$_GET['no'];
 // sql query for update data into database
 ...
 if(mysql_query($sql_query))
 {
  ...
  window.location.href='rekapruang.php';
  </script>
  <?php
 }
 else
...
{
 header("Location: rekapruang.php");
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Update Ruang</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="beranda.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Update Ruang</li>						  	
					</ol>
				</div>
			</div>
          <div class="container">
          <form method="post">
            ...
            <label class="control-label col-xs-2">ID Ruang</label>
            <div class="col-xs-4">
                <input type="text" name="kd_ruang" class="form-control" placeholder="ID Ruang" value="<?php echo $row['kd_ruang']; ?>">
            </div><br><br>
            <div class="form-group">
            <label class="control-label col-xs-2">Ruang</label>
            <div class="col-xs-4">
                <input type="text" name="ruang" class="form-control" placeholder="Ruang" value="<?php echo $row['ruang']; ?>">
            </div><br><br>
            <div class="form-group">
